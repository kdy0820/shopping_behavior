# Project Background
As a leading retail company in the B2C apparel space, the business relies on high transaction volumes across diverse product categories, including Clothing, Accessories, Footwear, and Outerwear. The management team has noticed recent changes in purchasing patterns across demographics and sales channels, prompting a need to better understand customer shopping behavior.
